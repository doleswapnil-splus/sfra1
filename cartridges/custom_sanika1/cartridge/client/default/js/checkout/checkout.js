...
var base1 = require('base/checkout/checkout');
            ...
            updateStage: function () {
                ...
                if (stage === 'customer') {
                    ...
                    if (isMultiShip && form.length === 0) {
                        ...
                        $('body').trigger('checkout:base1.disableButton', '.next-step-button button');
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                $('body').trigger('checkout:base1.enableButton', '.next-step-button button');
                                if (!data.error) {
                                    $('body').trigger(
                                        'checkout:base1.updateCheckoutView',
