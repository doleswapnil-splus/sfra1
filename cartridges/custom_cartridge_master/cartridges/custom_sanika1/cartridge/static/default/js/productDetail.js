...
/***/ (function(module, __unused_webpack_exports, __webpack_require__) {
 ...
 var base1 = __webpack_require__(6);
...
// function updateAddToCart(enableOrDisable) {
...
function updateAddToCart () {
    $('body').on('product:updateAddToCart', function (e, response) {
        // Update local add to cart button based on the product's availability
        $('button.add-to-cart', response.$productContainer).attr(
            'disabled',
            (!response.product.readyToOrder || !response.product.available)
        );

        // Update the personalize button based on the product's availability
        $('#personalizeButton').attr(
            'disabled',
            (!response.product.readyToOrder || !response.product.available)
        );

        // Check if all product availability conditions are met
        var enable = $('.product-availability').toArray().every(function (item) {
            return $(item).data('available') && $(item).data('ready-to-order');
        });

        // Enable or disable the Add to Cart button based on overall availability
        module.exports.methods.updateAddToCartEnableDisableOtherElements(!enable);

        // Enable or disable the Personalize button based on overall availability
...
//         };
//         $.ajax({
//             url: 'https://zzon-002.dx.commercecloud.salesforce.com/on/demandware.store/Sites-SanikaWadake-Site/default/wishlist-AddProduct', // Controller URL
//             method: 'POST',
//             data: form
//         });
//     });
...
// $(document).ready(function() {
//     addToWishlist();  // Initialize the wishlist functionality
// });



base.addToCart= base1.addToCart;

base.updateGiftCerticate=updateGiftCerticate;
base.closeModal=closeModal;
//base.addToWishlist=addToWishlist;
//base.updatePersonalizeButtonEnableDisableOtherElements=updatePersonalizeButtonEnableDisableOtherElements;
...
/***/ (function(module, __unused_webpack_exports, __webpack_require__) {
 ...
 var base1 = __webpack_require__(4);
 function getAddToCartUrl() {
    return $('.add-to-cart-url').val();
}
function getChildProducts() {
